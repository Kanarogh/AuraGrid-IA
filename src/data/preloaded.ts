import { createEmptyBrandGem, EMPTY_REPEATING_TEXT } from "../lib/brandGemDefaults";
...
/** @deprecated use createEmptyBrandGem — mantido só para imports legados */
export const DEFAULT_REPEATING_TEXT: RepeatingText = { ...EMPTY_REPEATING_TEXT };

/** @deprecated Gem vazio; preencha em Configurações por cliente */
export const DEFAULT_BRAND_GEM: BrandGem = createEmptyBrandGem("cliente", "");
